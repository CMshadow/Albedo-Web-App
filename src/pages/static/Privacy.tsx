    ...
    <Grid fluid>
      ...
      <Row justify='center'>
        <Typography style={{ maxWidth: '800px' }}>
          ...
          <Paragraph>
            Thank you for choosing to be part of our community at Albedo Inc, doing business as
            Albedo (&ldquo;Albedo&ldquo;, &ldquo;we&ldquo;, &ldquo;us-: or -our&ldquo;). We are
            ...
            your personal information, please contact us at admin@albedopowered.com.
          </Paragraph>
          <Paragraph>
            When you visit our website https://albedowebdesign.com/privacy (the
            &ldquo;Website&ldquo;), and more generally, use any of our services (the
            &ldquo;Services&ldquo;, which include the Website), we appreciate that you are trusting
          ...
          <Paragraph>1. WHAT INFORMATION DO WE COLLECT?</Paragraph>
          <Paragraph>2. HOW DO WE USE YOUR INFORMATION?</Paragraph>
          <Paragraph>3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</Paragraph>
          <Paragraph>4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</Paragraph>
          <Paragraph>5. DO WE USE GOOGLE MAPS?</Paragraph>
          <Paragraph>6. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</Paragraph>
          <Paragraph>7. HOW LONG DO WE KEEP YOUR INFORMATION?</Paragraph>
          <Paragraph>8. HOW DO WE KEEP YOUR INFORMATION SAFE?</Paragraph>
          <Paragraph>9. DO WE COLLECT INFORMATION FROM MINORS?</Paragraph>
          <Paragraph>10. WHAT ARE YOUR PRIVACY RIGHTS?</Paragraph>
          <Paragraph>11. CONTROLS FOR DO-NOT-TRACK FEATURES</Paragraph>
          <Paragraph>12. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</Paragraph>
          <Paragraph>13. DO WE MAKE UPDATES TO THIS NOTICE?</Paragraph>
          <Paragraph>14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</Paragraph>
          ...
          <Paragraph>In Short: We collect information that you provide to us.</Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            ...
            We collect names; email addresses; mailing addresses; usernames; passwords; billing
            addresses; debit/credit card numbers; project data; and other similar information.
          </Paragraph>
          <Paragraph>
            <Text style={{ fontWeight: 'bold' }}>Payment Data.</Text>
            ...
            associated with your payment instrument. All payment data is stored by Stripe. You may
            find their privacy notice link(s) here:
            <a
              href='https://stripe.com/zh-hans-cn-us/privacy'
              target='_blank'
              rel='noopener noreferrer'
            >
              &ldquo;https://stripe.com/privacy.&ldquo;
            </a>
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph style={{ fontWeight: 'bold' }}>Information automatically collected</Paragraph>
          <Paragraph>
            <Text style={{ fontWeight: 'bold' }}>In Short:</Text>
          ...
          <ul>
            <li>
              ...
              and information about your activity in the Website (such as the date/time stamps
              ...
              activity, error reports (sometimes called &lsquo;crash dumps&lsquo;) and hardware
              settings).
            </li>
            <br />
            <li>
              ...
              device application identification numbers, location, browser type, hardware model
              Internet service provider and/or mobile carrier, operating system configuration
              information.
            </li>
            <br />
            <li>
              Location Data. We collect information data such as information about your
              device&lsquo;s location, which can be either precise or imprecise. How much
              information we collect depends on the type of settings of the device you use to access
              the Website. For example, we may use GPS and other technologies to collect geolocation
              ...
              information or by disabling your Locations settings on your device. Note however, if
          ...
          <Paragraph>
            ...
            consent. We use personal information collected via our Website for a variety of business
          ...
          <ul>
            <li>
              ...
              Google or Facebook account), we use the information you allowed us to collect from
              those third parties to facilitate account creation and logon process for the
              performance of the contract.
            </li>
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>To post testimonials.</Text>
              We post testimonials on our Website that may contain personal information. Prior to
              posting a testimonial, we will obtain your consent to use your name and the consent of
              the testimonial. If you wish to update, or delete your testimonial, please contact us
              at admin@albedopowered.com and be sure to include your name, testimonial location, and
              contact information.
            </li>
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>Request feedback.</Text>
              We may use your information to request feedback and to contact you about your use of
              our Website.
            </li>
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>To enable user-to-user communications.</Text>
              We may use your information in order to enable user-to-user communications with each
              user&lsquo;s consent.
            </li>
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>To manage user accounts.</Text>
              We may use your information for the purposes of managing our account and keeping it in
              working order.
            </li>
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>To send administrative information to you.</Text>
            ...
            <li>
              ...
              We may use your information as part of our efforts to keep our Website safe and secure
            ...
            <li>
              ...
              If we receive a subpoena or other legal request, we may need to inspect the data we
              hold to determine how to respond.
            </li>
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>Fulfill and manage your orders.</Text>
              We may use your information to fulfill and manage your orders, payments, returns, and
              exchanges made through the Website.
            </li>
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>Administer prize draws and competitions.</Text>
              We may use your information to administer prize draws and competitions when you elect
            ...
            <li>
              ...
              We may use your information to respond to your inquiries and solve any potential
            ...
            <li>
              ...
              We and/or our third-party marketing partners may use the personal information you send
              ...
              collect personal information from you. You can opt-out of our marketing emails at any
              time (see the &ldquo;WHAT ARE YOUR PRIVACY RIGHTS&ldquo; below).
            </li>
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>Deliver targeted advertising to you.</Text>
              We may use your information to develop and display personalized content and
            ...
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>Feature Improvement.</Text>
            </li>
            <br />
          </ul>
          ...
          <Paragraph>
            This Website uses Google Maps APIs which is subject to Google&lsquo;s Terms of Service.
            You may find the Google Maps APIs Terms of Service
            <a
            ...
            . To find out more about Google&lsquo;s Privacy Policy, please refer to this
            <a
          ...
          <Paragraph>
            ...
            accounting or other legal requirements). No purpose in this notice will require us
            keeping your personal information for longer than the period of time in which users have
            an account with us. When we have no ongoing legitimate business need to process your
            personal information, we will either delete or anonymize such information, or, if this
            is not possible (for example, because your personal information has been stored in
          ...
          <Paragraph>
            ...
            guardian of such a minor and consent to such minor dependent&lsquo;s use of the Website.
            ...
            from children under age 18, please contact us at admin@albedopowered.com.
          </Paragraph>
          ...
          <Paragraph>
            ...
            http://ec.europa.eu/justice/data-protection/bodies/authorities/index en.html.
          </Paragraph>
          <Paragraph>
            If you are resident in Switzerland, the contact details for the data protection
            authorities are available here: https:llwww.edoeb.admin.chledoeblen/home.html.
          </Paragraph>
          <Paragraph>
            If you have questions or comments about your privacy rights, you may email us at
            admin@albedopowered.com.
          </Paragraph>
          <Paragraph style={{ fontWeight: 'bold' }}>Account Information</Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            <Text style={{ fontWeight: 'bold' }}>Cookies and similar technologies:</Text>
            ...
            <a href='https://albedowebdesign.com/cookies' target='_blank' rel='noopener noreferrer'>
              https://albedowebdesign.com/cookies
            </a>
            .
          </Paragraph>
          <Paragraph>
            <Text style={{ fontWeight: 'bold' }}>Opting out of email marketing:</Text>
          ...
          <Paragraph>
            ...
            Do-Not-Track (&ldquo;DNT&ldquo;) feature or setting you can activate to signal your
          ...
          <Paragraph>
            California Civil Code Section 1798.83, also known as the &lsquo;Shine The Light&lsquo;
          ...
          <Paragraph>
            ...
            indicated by an updated &ldquo;Revised&ldquo; date and the updated version will be
          ...
          <Paragraph>
            ...
            admin@albedopowered.com or by post to:
          </Paragraph>
          <Paragraph>Albedo Inc 2001 E Miraloma Ave</Paragraph>
          <Paragraph>Placentia, CA 92870</Paragraph>
