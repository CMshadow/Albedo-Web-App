    ...
    <Grid fluid>
      ...
      <Row justify="center">
        <Typography style={{ maxWidth: '800px' }}>
          ...
          <Paragraph>
            Thank you for choosing to be part of our community at Albedo Inc, doing business as Albedo (“Albedo", "we",
            ...
            information, please contact us at admin@albedopowered.com.
          </Paragraph>
          <Paragraph>
            When you visit our website https://albedowebdesign.com/privacy (the "Website"), and more generally, use any
            of our services (the "Services", which include the Website), we appreciate that you are trusting us with
            your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain
          ...
          <Paragraph style={{ fontWeight: 'bold' }}>Personal information you disclose to us</Paragraph>
          ...
          <Paragraph>
            ...
            We collect names; email addresses; mailing addresses; usernames; passwords; billing addresses; debit/credit
            card numbers; project data; and other similar information.
          </Paragraph>
          <Paragraph>
            ...
            payment data is stored by Stripe. You may find their privacy notice link(s) here:
          ...
          <ul>
            ...
            <li>
              ...
              hardware model Internet service provider and/or mobile carrier, operating system configuration
              information.
            </li>
            <br />
            <li>
              Location Data. We collect information data such as information about your device's location, which can be
              either precise or imprecise. How much information we collect depends on the type of settings of the device
          ...
          <Paragraph>
            ...
            contract with you, compliance with our legal obligations, and/or your consent. We use personal information
            collected via our Website for a variety of business purposes described below.
          </Paragraph>
          <Paragraph>
          ...
          <ul>
            <li>
              <Text style={{ fontWeight: 'bold' }}>To facilitate account creation and logon process.</Text>
              If you choose to link your account with us to a third-party account (such as your Google or Facebook
              account), we use the information you allowed us to collect from those third parties to facilitate account
              creation and logon process for the performance of the contract.
            </li>
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>To post testimonials.</Text>
              We post testimonials on our Website that may contain personal information. Prior to posting a testimonial,
              we will obtain your consent to use your name and the consent of the testimonial. If you wish to update, or
              delete your testimonial, please contact us at admin@albedopowered.com and be sure to include your name,
            ...
            <li>
              ...
              We may use your information as part of our efforts to keep our Website safe and secure (for example, for
            ...
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>To respond to legal requests and prevent harm.</Text>
              If we receive a subpoena or other legal request, we may need to inspect the data we hold to determine how
              to respond.
            </li>
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>Fulfill and manage your orders.</Text>
              We may use your information to fulfill and manage your orders, payments, returns, and exchanges made
              through the Website.
            </li>
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>Administer prize draws and competitions.</Text>
              We may use your information to administer prize draws and competitions when you elect to participate in
              our competitions.
            </li>
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>To deliver and facilitate delivery of services to the user.</Text>
              We may use your information to provide you with the requested service.
            </li>
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>To respond to user inquiries/offer support to users.</Text>
            ...
            <br />
            <li>
              <Text style={{ fontWeight: 'bold' }}>To send you marketing and promotional communications.</Text>
              We and/or our third-party marketing partners may use the personal information you send to us for our
          ...
          <Paragraph>
            This Website uses Google Maps APIs which is subject to Google's Terms of Service. You may find the Google
          ...
          <Paragraph>
            ...
            notice. We are not responsible for the content or privacy and security practices and policies of any third
            parties, including other websites, services or applications that may be linked to or from the Website. You
          ...
          <Paragraph>
            ...
            unless otherwise required by law. We will only keep your personal information for as long as it is necessary
            for the purposes set out in this privacy notice, unless a longer retention period is required or permitted
            by law (such as tax, accounting or other legal requirements). No purpose in this notice will require us
          ...
          <Paragraph>
            ...
            such minor dependent's use of the Website. If we learn that personal information from users less than 18
          ...
          <Paragraph>
            ...
            can find their contact details here: http://ec.europa.eu/justice/data-protection/bodies/authorities/index
            en.html.
          </Paragraph>
          <Paragraph>
            If you are resident in Switzerland, the contact details for the data protection authorities are available
            here: https:llwww.edoeb.admin.chledoeblen/home.html.
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            ...
            could affect certain features or services of our Website. To opt-out of interest-based advertising by
          ...
          <Paragraph>
            ...
            marketing email list — however, we may still communicate with you, for example to send you service-related
            emails that are necessary for the administration and use of your account, to respond to service requests, or
          ...
          <Paragraph>
            If you have questions or comments about this notice, you may email us at admin@albedopowered.com or by post
            to:
          </Paragraph>
