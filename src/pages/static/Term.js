      ...
      <Row justify="center">
        <Typography style={{ maxWidth: '800px' }}>
          ...
          <Paragraph>
            ...
            of an entity (“you”) and Albedo Inc, doing business as Albedo ("Albedo", “we”, “us”, or “our”), concerning
            your access to and use of the https://albedowebdesign.com website as well as any other media form, media
            channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively,
            the “Site”). You agree that by accessing the Site, you have read, understood, and agree to be bound by all
            of these Terms of Use, including the Services Agreement posted on the Site, which are incorporated into
            these Terms of Use.{' '}
            <Text strong>
          ...
          <Paragraph>
            If you are unsatisfied with our services, please email us at admin@albedopowered.com or call us at
            9495589632.
          </Paragraph>
          <Row justify="center">
          ...
          <Paragraph>
            ...
            https://albedowebdesign.com/terms. By using the Site, you agree to be bound by our Privacy Policy, which is
            incorporated into these Terms of Use. Please be advised the Site is hosted in the United States. If you
            ...
            data transferred to and processed in the United States. Further, we do not knowingly accept, request, or
            ...
            provided personal information to us without the requisite and verifiable parental consent, we will delete
          ...
          <Paragraph>
            ...
            <Text strong>
              ...
              DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF THE SITE (INCLUDING BLOCKING CERTAIN
              IP ADDRESSES), TO ANY PERSON FOR ANY REASON OR FOR NO REASON, INCLUDING WITHOUT LIMITATION FOR BREACH OF
              ANY REPRESENTATION, WARRANTY, OR COVENANT CONTAINED IN THESE TERMS OF USE OR OF ANY APPLICABLE LAW OR
              REGULATION. WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SITE OR DELETE YOUR ACCOUNT AND ANY CONTENT
          ...
          <Paragraph>
            ...
            Agreement to the jurisdiction of the Delaware courts. Albedo Inc shall also maintain the right to bring
          ...
          <Paragraph>
            <Text strong>
              ...
              ALL TIMES BE LIMITED TO THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE ONE (1) MONTH
              PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR $150.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS
              DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE
              LAWS APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY
