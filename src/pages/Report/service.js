...
export const getReport = ({ projectID, buildingID }) => async dispatch => {
  try {
    ...
    return axios
      .get(`/project/${auth.username}/${projectID}/${buildingID}/report`, {
        headers: { 'COG-TOKEN': auth.signInUserSession.idToken.jwtToken },
      })
      .then(res => res.data)
      .catch(err => {
...
export const deleteReport = ({ projectID }) => async dispatch => {
  try {
    ...
    return axios
      .delete(`/project/${auth.username}/${projectID}/_/report`, {
        headers: { 'COG-TOKEN': auth.signInUserSession.idToken.jwtToken },
      })
      .then(res => res.data)
      .catch(err => {
...
export const getProductionData = ({ projectID, buildingID, month, day, dataKey }) => async (
  ...
  try {
    ...
    return axios
      .get(`/project/${auth.username}/${projectID}/${buildingID}/production`, {
...
export const deleteProductionData = ({ projectID }) => async dispatch => {
  try {
    ...
    return axios
      .delete(`/project/${auth.username}/${projectID}/_/production`, {
        headers: { 'COG-TOKEN': auth.signInUserSession.idToken.jwtToken },
      })
      .then(res => res.data)
      .catch(err => {
...
export const getIrradianceData = ({ projectID, buildingID, month, day, tilt, azimuth }) => async (
  dispatch,
  getState
) => {
  try {
    ...
    return axios
      .get(`/project/${auth.username}/${projectID}/${buildingID}/irradiance`, {
...
export const deleteIrradianceData = ({ projectID }) => async dispatch => {
  try {
    ...
    return axios
      .delete(`/project/${auth.username}/${projectID}/_/irradiance`, {
        headers: { 'COG-TOKEN': auth.signInUserSession.idToken.jwtToken },
      })
      .then(res => res.data)
      .catch(err => {
...
export const downloadReportCSV = ({ projectID, buildingID }) => async dispatch => {
  try {
    ...
    return axios
      .get(`/project/${auth.username}/${projectID}/${buildingID}/csv`, {
        headers: { 'COG-TOKEN': auth.signInUserSession.idToken.jwtToken },
      })
      .then(res => res.data)
      .catch(err => {
