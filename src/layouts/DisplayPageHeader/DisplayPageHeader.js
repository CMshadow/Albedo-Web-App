...
const disPlayPageHeader = () => (<div className="DiplayPageHeader">
  <Header style={{
    ...
    <nav className="DiplayPageHeader-nav">
      ...
      <ul className="DiplayPageHeader-nav-item">
        <li>
          <a>
            <Link to="/cn">产品功能</Link>
          </a>
          <a>
            <Link to="/cn">产品定价</Link>
          </a>
        </li>
      ...
      <Link to="/user/login">
        <Button style={{
            ...
            float: 'right',
            marginTop: '15px'
          }} shape="middle" size='large'>登录</Button>
      </Link>
      <Link to="/user/register">
        <Button style={{
            ...
            marginTop: '15px',
            marginRight: '80px'
          }} shape="middle" size='large'>快速注册</Button>
      </Link>
