...
import { BingMapsImageryProvider, BingMapsStyle, UrlTemplateImageryProvider, createWorldTerrain, SceneMode } from 'cesium';
...
export const CustomViewer = (props) => {
  ...
  const bingMap = new BingMapsImageryProvider({
  ...
  const googleMap = new UrlTemplateImageryProvider({
