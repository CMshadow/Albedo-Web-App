...
const SelfUseMeter = props => {
  ...
  const DrawMeter = () => {
    ...
    drawSwictchPort([accessPort[0] + unitWidth * 0.6, accessPort[1] - unitHeight * 0.35 + 10])
    drawMeterBox()
    drawServicePanel()
    drawMarks()
    return groupOfMeter
  ...
  const drawServicePanel = params => {
    ...
    drawSwictchPort([accessPort[0] + unitWidth * 0.4, accessPort[1] - unitHeight * 0.15 + 12.5])
    drawSwictchPort([accessPort[0] + unitWidth * 0.55, accessPort[1] - unitHeight * 0.15 + 12.5])
    drawSwictchPort([accessPort[0] + unitWidth * 0.75, accessPort[1] - unitHeight * 0.15 + 12.5])
  }
  ...
  const drawMeterBox = () => {
    ...
    groupOfMeter.push(
      <Arrow
        ...
        points={[
          accessPort[0] + unitWidth * 1.2,
          accessPort[1] - unitHeight * 0.5 - 5,
          accessPort[0] + unitWidth * 1.2,
          accessPort[1] - unitHeight * 0.7,
        ]}
        pointerLength={5}
        pointerWidth={5}
        stroke='black'
