...
const PanelArrayCollection = (props) => {
  ...
  const drawInverter = () => {
    ...
    groupOfPvArray.push(<Line 
      ...
      points={[startPosition[0] + unitWidth * 2.165,
        startPosition[1] + 1.4 * unitHeight, 
        startPosition[0] + unitWidth * 5.135,
        startPosition[1] + 1.4 * unitHeight]}
      stroke='#7b7b85'
      strokeWidth={2}
      lineCap='round'
  ...
  const drawAccessPorts = (numOfArray) => {
    ...
    for (let index = 0; index < numOfArray; index++) {
      ...
      groupOfPvArray.push(<Line 
        key= {"Boundary-Line-" + uuidv4()}
        points={[startPosition[0] + unitWidth * 2.165 + 
        index * unitPortWidth + offSet * 0.5,
          startPosition[1] + 1.4 * unitHeight, 
          startPosition[0] + unitWidth * 2.165 +
          index * unitPortWidth + offSet * 0.5,
      ...
      const endPoint = startPosition[1] + 1.5 * unitHeight + 12.5 > 
      startPosition[1] + 1.65 * unitHeight ? 
  ...
  const drawSingleArray = (startPoint, unitW, index) => {
    ...
    groupOfPvArray.push(<Line 
      ...
      groupOfPvArray.push(<Line 
        key= {"PV-Array-Line-" + uuidv4()}
        points={[startPoint[0] - unitW * 0.4 + 5,
