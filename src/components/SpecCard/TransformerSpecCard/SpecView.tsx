...
type SpecViewProps = { transformerIndex: number }

export const SpecView: React.FC<SpecViewProps> = ({ transformerIndex }) => {
  const { t } = useTranslation()
  const unit = useSelector((state: RootState) => state.unit.unit)
  const transformers = useSelector((state: RootState) => state.project?.transformers || [])
