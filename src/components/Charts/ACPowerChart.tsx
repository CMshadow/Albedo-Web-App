...
type ACPowerChartProps = { buildingID: string }

export const ACPowerChart: React.FC<ACPowerChartProps> = ({ buildingID }) => {
  ...
  const scale = {
    ...
    value: {
      ...
      formatter: (text: number) =>
        `${text.toFixed(2)} ${reportData[buildingID].month_AC_power.unit}`,
      nice: true,
    },
  }
