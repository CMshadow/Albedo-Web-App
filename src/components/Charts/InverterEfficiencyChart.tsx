...
type InverterEfficiencyChartProps = {
  dataSource: { pac_percent: number; eff: number; vdc: string }[]
}

export const InverterEfficiencyChart: React.FC<InverterEfficiencyChartProps> = ({ dataSource }) => {
