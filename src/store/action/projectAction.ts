...
import { 
  RootState, ProjectActionTypes, Project, AddBuildingParams, EditBuildingParams,
  SetBuildingReGenReportParams, EditSubAryParams, DeleteSubAryParams,
  AddInverterSpecParams, EditInverterSpecParams, DeleteInverterSpecParams,
  EditCombiboxParams, DeleteCombiboxParams, EditTransformerParams, EditPowercabinetParams
} from '../../@types'
...
export const setProjectData: IAction<Project, void> = 
...
export const updateProjectAttributes: IAction<Partial<Project>, void> = 
...
export const releaseProjectData: IAction<void, void> = 
() => (dispatch, getState) => {
  dispatch({
...
export const addBuilding: IAction<AddBuildingParams, void> = 
(values) => (dispatch, getState) => {
  dispatch({
...
export const deleteBuilding: IAction<string, void> = 
...
({buildingID, reGenReport}) => (dispatch, getState) => {
  return dispatch({
...
({buildingID, specIndex}) => (dispatch,getState) => {
  dispatch({
...
({buildingID, specIndex, invIndex, ...values}) => (dispatch, getState) => {
  dispatch({
...
export const addCombibox: IAction<string, void> = 
(buildingID) => (dispatch, getState) => {
  dispatch({
...
({buildingID, combiboxIndex, ...values}) => (dispatch, getState) => {
  dispatch({
...
({buildingID, combiboxIndex}) => (dispatch, getState) => {
  dispatch({
...
({transformerIndex, ...values}) => (dispatch, getState) => {
  dispatch({
...
export const deleteTransformer: IAction<number, void> = 
(transformerIndex) => (dispatch, getState) => {
  dispatch({
...
({powercabinetIndex, ...values}) => (dispatch, getState) => {
  return dispatch({
...
export const deletePowercabinet: IAction<number, void> = 
(powercabinetIndex) => (dispatch, getState) => {
  return dispatch({
