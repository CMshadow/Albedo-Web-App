...
export const SET_UI_CREATE_BUILDING = 'SET_UI_CREATE_BUILDING'
export const SET_UI_DRAWING = 'SET_UI_DRAWING'

export const MODELING_CREATE_BUILDING = 'MODELING_CREATE_BUILDING'
export const SET_MODELING_LOADING = 'SET_MODELING_LOADING'
export const BIND_DRAWING_OBJECT = 'BIND_DRAWING_OBJECT'
export const DELETE_DRAWING_OBJECT = 'DELETE_DRAWING_OBJECT'
